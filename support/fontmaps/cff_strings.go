...
// cffStandardStrings è la tabella dei 391 SID predefiniti della specifica CFF
// (Adobe Tech Note 5176, Appendice A). I SID >= len(cffStandardStrings) indicizzano
// invece la String INDEX propria del font.
